...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        self.slider_1 = customtkinter.CTkSlider(master=self.frame_control, from_=1, to=1000)
    ...
    def animateZW(self):
        ...
        for i in range(int(self.slider_1.get())):
            ...
            for num in x:
                for anothernum in y:
                    wowee = self.getW(num,anothernum)
                    matplotlib.pyplot.scatter(wowee.real, wowee.imag, marker = ".", c = ['#ff7f0e'])
